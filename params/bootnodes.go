...
// ZephyriaBootnodes are the enode URLs of the P2P bootstrap nodes running on the
// Zephyria network.
var ZephyriaBootnodes = []string{
/*
	// EF DevOps
...
// HaryanaBootnodes are the enode URLs of the P2P bootstrap nodes running on the
// Haryana test network.
var HaryanaBootnodes = []string{
	/*
...
func KnownDNSNetwork(genesis common.Hash, protocol string) string {
	...
	case SepoliaGenesisHash:
		net = "sepolia"
	case ZephyriaGenesisHash:
		net = "zephyria"
	case HaryanaGenesisHash:
		net = "haryana"
	default:
		return ""
	}
